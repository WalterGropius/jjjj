...
export function ContactSection() {
  return (
    <section id="kontakt" className="relative scroll-mt-24 overflow-hidden px-6 py-24 md:px-10 md:py-36">
      <div
        aria-hidden
      ...
      <div className="relative mx-auto max-w-[1600px]">
        ...
        <motion.h2
          ...
          className="font-display text-[clamp(3rem,9vw,9rem)] font-black leading-[0.9] tracking-tightest text-line-white"
        >
          <span className="block">Chcete</span>
          <motion.span
            initial={{ scaleX: 0 }}
            ...
            className="my-2 block h-[0.06em] w-full bg-line-red"
          />
          <span className="block pl-[15%] text-line-red">být vidět?</span>
        </motion.h2>
        ...
        <div className="mt-16 grid gap-12 md:grid-cols-12">
          <div className="md:col-span-6">
            <a
              ...
              onClick={(e) => {
                e.preventDefault()
                window.location.href = 'mailto:info@lineevents.cz'
              }}
            >
